...
class Controller(QApplication):
    ...
    def calculate_characterisation(self):
        ...
        # self.model.update_parameters(self.model.table_data)
...
class View(QMainWindow):
    ...
    def __init__(self, controller, model):
        ...
        self.window_layout.addWidget(self.tab_bar)
        ...
        # self.laser_tec_table = QtWidgets.QTableView(self.frames["Configuration"])
        self.__init_config()
        self.__init_buttons()
        self.__init_plots()
        self.__init_logging()
    ...
    def create_tab(self, text):
        self.tabs[text] = QtWidgets.QTabWidget(self)
        self.tabs[text].setLayout(QtWidgets.QGridLayout(self))
        self.tab_bar.addTab(self.tabs[text], text)

    def set_frame(self, master, title, x, y):
        self.frames[title] = QtWidgets.QGroupBox(self.tabs[master])
        self.frames[title].setTitle(title)
        layout = QtWidgets.QGridLayout(self.tabs[master])
    ...
    def __init_configuration_buttons(self):
        ...
        self.buttons["Configuration"]["Save Settings"] = QtWidgets.QPushButton("Save Settings", parent=sub_layout)
        ...
        self.buttons["Configuration"]["Load Settings"] = QtWidgets.QPushButton("Load Settings", parent=sub_layout)
        ...
        button = QtWidgets.QPushButton("Help", parent=sub_layout)
    ...
    def __init_offline_buttons(self):
        ...
        self.buttons["Offline"]["Decimation"] = QtWidgets.QPushButton("Decimation", parent=self.frames["Offline"])
        ...
        self.buttons["Offline"]["Inversion"] = QtWidgets.QPushButton("Inversion", parent=self.frames["Offline"])
    ...
    def __init_plotting_buttons(self):
        ...
        self.buttons["Plotting"]["Decimation"] = QtWidgets.QPushButton("Decimation", parent=self.frames["Plotting"])
        ...
        self.buttons["Plotting"]["Inversion"] = QtWidgets.QPushButton("Inversion", parent=self.frames["Plotting"])
    ...
    def __init_live_buttons(self):
        ...
        self.buttons["Live Measurement"]["PTI"] = QtWidgets.QPushButton("PTI", parent=self.frames["Live Measurement"])
...
#        self.frames["Configuration"].layout().addWidget(self.laser_tec_table, 1, 0)
...
class _Plotting(pg.PlotWidget):
    ...
    def init_amplitudes(self, parent: QtWidgets):
        ...
        plot.addLegend()
        self.curves.amplitudes = [plot.scatterPlot(pen=pg.mkPen(_MatplotlibColors.BLUE), name="Amplitude CH1"),
                                  plot.scatterPlot(pen=pg.mkPen(_MatplotlibColors.ORANGE), name="Amplitude CH2"),
                                  plot.scatterPlot(pen=pg.mkPen(_MatplotlibColors.GREEN), name="Amplitude CH3")]
        plot.setLabel(axis="bottom", text="Time [s]")
    ...
    def init_output_phases(self, parent: QtWidgets):
        ...
        plot.addLegend()
        self.curves.output_phases = [plot.scatterPlot(pen=pg.mkPen(_MatplotlibColors.ORANGE), name="Output Phase CH2"),
                                     plot.scatterPlot(pen=pg.mkPen(_MatplotlibColors.GREEN), name="Output Phase CH3")]
        plot.setLabel(axis="bottom", text="Time [s]")
