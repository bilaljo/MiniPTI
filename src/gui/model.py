...
class Model:
    ...
    def calculate_characitersation(self, dc_file_path, inversion_path="", use_inversion=False,
                                   settings_path="settings.csv"):
        self.pti.calculcate_characterisation(dc_path=dc_file_path, pti_path=inversion_path, settings_path=settings_path)
